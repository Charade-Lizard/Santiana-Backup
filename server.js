...
const guildId = "763799719365050378";
let commandChanId = "763829735129612309";
let textChannelId = "763829733753749516";
let voiceChannelId = "763829711183937578";
client.on("ready", () => {
...
function loadChanIds(){
  ...
  guild.channels.forEach(gchannel => {
    if (gchannel.type == "text" && gchannel.name == "⚚-santiana-chat") {
      commandChanId = gchannel.id;
    } else if (gchannel.type == "text" && gchannel.name == "⚚-santiana-chat") {
      textChannelId = gchannel.id;
    } else if (gchannel.type == "voice" && gchannel.id == "763829709984497674") {
